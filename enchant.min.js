...
function dum(){console.log("hogehoge")};//added
// t.cancelable ? t.preventDefault() : dum() -> t.cancelable ? t.cancelable ? t.preventDefault() : dum() : dum()